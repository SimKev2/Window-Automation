...
class WindowManager:
    ...
    def set_foreground(self):
        ...
        win32gui.SetWindowPos(self._handle, win32con.HWND_NOTOPMOST, 0, 0, 0, 0, win32con.SWP_NOMOVE + win32con.SWP_NOSIZE + win32con.SWP_SHOWWINDOW)
    ...
    def move_window(self, w_NewX, w_NewY):
        win32gui.SetWindowPos(self._handle, win32con.HWND_TOP, w_NewX, w_NewY, self._width, self._height, win32con.SWP_NOSIZE)
        self.get_screen_pos()
    ...
    def get_cursor_pos(self):
        ...
        print("Abs_MouseX: {0}, Abs_MouseY: {1}, Win_MouseX: {2}, Win_MouseY: {3}".format(m_x, m_y, m_x-self._xCoord, m_y-self._yCoord), end='\r')
